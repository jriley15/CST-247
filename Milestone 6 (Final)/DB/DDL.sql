...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2018 at 04:48 AM
...
--
ALTER TABLE `cells`
  ADD CONSTRAINT `fk_GRID_ID` FOREIGN KEY (`GRIDID`) REFERENCES `grids` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `games`
--
ALTER TABLE `games`
  ADD CONSTRAINT `fk_GRIDID` FOREIGN KEY (`GRIDID`) REFERENCES `grids` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_USERID` FOREIGN KEY (`USERID`) REFERENCES `users` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `grids`
--
ALTER TABLE `grids`
  ADD CONSTRAINT `grids_ibfk_1` FOREIGN KEY (`USERID`) REFERENCES `users` (`ID`);
COMMIT;
